    ...
    if(!window.define){
        window.define = function define(){
            ...
            if(argPos<arguments.length && typeof arguments[argPos] === "string"){
                ...
                name=window.globalModuleName || document.currentScript.src.replace(/.*\/([^/\.]*)(.js)?/,function(all,part){ return part; });
            }
            ...
            window.require.definedModules[name] = window[name] = factory.apply(window, dependencies.map(function(moduleName){ return require(moduleName) }));
        }
