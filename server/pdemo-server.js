...
var server = app.listen(PORT, function(){
    ...
    var phantomPath=process.env.TRAVIS && process.env.TRAVIS_NODE_VERSION<'6.0'?'phantomjs':'./node_modules/phantomjs-prebuilt/lib/phantom/'+(winOS?'bin/phantomjs.exe':'bin/phantomjs');
